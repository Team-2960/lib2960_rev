...
This portion of the library includes implementations of the [lib2960](https://github.com/Team-2960/lib2960) classes using the RevLib Phoenix vendor libraries.

## Prerequisites  
The following is required for this library to work correctly
- [lib2960](https://github.com/Team-2960/lib2960) submodule
- [RevLib](https://docs.revrobotics.com/ion-control-system/sw/revlib)
...
4. Add this library as a submodule using the following commands in the terminal
    ...
    ```
    git submodule add https://github.com/Team-2960/lib2960_rev.git src\main\java\frc\lib2960_rev
    cd src\main\java\frc\lib2960_rev
